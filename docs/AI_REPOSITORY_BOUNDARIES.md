...
- 4090/Tailscale/OpenSSH/GitHub Actions/MCP 운영 문서와 운영 스크립트는 `docs/ai-artifacts/docs/ops/`, `docs/ai-artifacts/scripts/ops/` 에 둔다. CareerTuner main repo 의 `docs/ops/`, `scripts/ops/` 에 새 파일을 쌓지 않는다.
