...
기준 branch: dev
기준 PR 범위: #174, #175, #180, #182, #183, #184, #186, #187, #188, #190, #191, #193, #198 포함
...
- [~] 보류 또는 조건부 유지 — RAG runtime 재도입은 reports/74 결과 기준으로도 `KEEP_RAG_DISABLED` 를 유지하고, offline/scoped 재평가 후보로만 둔다.
- [ ] 미완료 — independent semantic judge disagreement 13건에 대한 human review 와 multi-judge consensus 는 후속으로 남아 있다.
...
- [ ] 미완료 — RAG hard-case independent semantic judge disagreement human review 와 multi-judge consensus.
