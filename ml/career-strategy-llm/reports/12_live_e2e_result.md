...
## 6. 남은 이슈
- ✅ 프런트 화면 캡처는 4090 로컬에서 확보(§1-A, case 2). 노트북엔 모델 없음 → 원격 호출(PART B~D) 필요.
...
- 원격 호출(시연 장소 ≠ 4090): 4090 Tailscale 미설치 확인 → 신규 가입 필요(`reports/13`·`14`). PART B는 팀 승인 + C/팀 tailnet 선택 대기 중.
