...
- 2026-07-01 ChatGPT/Claude/Gemini 인터페이스의 현재 최상위 reasoning/analysis 모델에 붙여넣을 평가팩과 label taxonomy v2 를 생성했다. 아직 top LLM 결과 취합 전이므로 RAG runtime 판단은 `KEEP_RAG_DISABLED` 로 유지한다.
