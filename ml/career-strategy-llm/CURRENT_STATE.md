...
- 2026-07-01 GPT/Claude/Gemini급 top LLM judge 에 붙여넣을 평가팩과 label taxonomy v2 를 생성했다. 아직 top LLM 결과 취합 전이므로 RAG runtime 판단은 `KEEP_RAG_DISABLED` 로 유지한다.
...
- top LLM judge pack artifact 는 CareerTunerAI `benchmarks/rag-hardcase/top-llm-judge-packs/rag_hardcase_v1_20260630_1635_top_llm_judge_pack` 및 `rag_hardcase_v1_20260630_1635_top_llm_judge_pack_disagreement13`에 있고, commit은 `499a01051e0bd58d0f10045620d866a57c43f756`다.
- top LLM judge pack 장문 계획 문서는 CareerTunerAIDocs `areas/c-career-strategy/reports/75_rag_hardcase_top_llm_judge_pack_plan.md`에 있고, commit은 `b139199d16761d727aaf3c9db3bbb27480790200`다.
