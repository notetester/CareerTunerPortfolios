window.SECOND_BRAIN_GRAPH = (() => {
  ...
  const nodes = [
    ...
    n("pages-deploy", "CareerTunerPortfolios Deploy", "release", "automation", 18, "정화된 공개 소스에서 Pages 산출물을 빌드하고 배포합니다.", ["기존 Obsidian/ 경로를 보존하도록 배포 workflow가 정리돼 있습니다."], ".github/workflows/pages.yml", ["web-demo", "portfolio-graph"]),
  ...
  const sources = [
    ...
    source("CareerTuner 공개 Architecture Projection", "지원 건 중심 도메인, Spring/MyBatis, React/Admin, AI 경계를 공개 graph data로 투영했습니다.", "https://github.com/notetester/CareerTunerPortfolios/blob/dev/Obsidian/SecondBrain/graph-data.js"),
    source("CareerTuner 공개 Obsidian Wiki", "비공개 원본에서 선별한 wiki/index, GRAPH_REPORT, log의 공개 설명 계층입니다.", "https://github.com/notetester/CareerTunerPortfolios/tree/dev/Obsidian/Wiki"),
  ];
