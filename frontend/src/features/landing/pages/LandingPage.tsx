...
const STEP_DEFS = [
  { icon: "💬", t: "인테이크 챗봇", d: "요청 분석 · 회사·직무·레벨 파악" },
  { icon: "🧠", t: "두뇌 · Plan", d: "확정 슬롯 → 실행계획 생성" },
  { icon: "📋", t: "공고 분석", d: "필수·우대·담당업무 추출" },
  { icon: "🎯", t: "적합도·전략", d: "프로필 대비 적합도·부족역량" },
  { icon: "📝", t: "자소서·첨삭", d: "자소서 초안 · 답변 첨삭" },
  { icon: "🎤", t: "모의면접", d: "예상 질문 · 평가 · 리포트" },
  { icon: "👥", t: "커뮤니티 추천", d: "관련 후기 · 실제 기출" },
];
