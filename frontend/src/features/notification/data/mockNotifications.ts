...
export const mockNotifications: Notification[] = [
  { id: 1, category: "ai_analysis", type: "JOB_ANALYSIS_COMPLETE", icon: "FileSearch", title: "이력서 분석이 완료됐어요", message: "백엔드 개발자 직무 기준 분석 리포트가 준비되었습니다. 직무 적합도 82점이에요.", createdAt: "방금", isRead: false, link: "이력서 분석 리포트" },
  ...
  { id: 8, category: "ai_analysis", type: "PROFILE_ANALYZED", icon: "RotateCcw", title: "무료 분석 횟수가 충전됐어요", message: "이번 달 무료 이력서 분석 3회가 다시 충전되었습니다.", createdAt: "어제", isRead: true, link: "이력서 분석" },
