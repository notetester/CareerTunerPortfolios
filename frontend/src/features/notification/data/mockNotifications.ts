...
export const mockNotifications: Notification[] = [
  ...
  { id: 11, category: "billing", type: "PAYMENT_COMPLETE", icon: "CreditCard", title: "결제가 완료됐어요", message: "프로 플랜(월 9,900원) 결제가 정상 처리되었습니다.", createdAt: "2026-06-06T15:00:00", isRead: true, link: "/billing?tab=history" },
  { id: 12, category: "billing", type: "CREDIT_RECHARGED", icon: "CreditCard", title: "무료 분석 횟수가 충전됐어요", message: "이번 달 무료 이력서 분석 3회가 다시 충전되었습니다.", createdAt: "2026-06-05T09:00:00", isRead: true, link: "/billing?tab=credits" },
];
