...
export const demoInterviewSessions: InterviewSession[] = [
  { id: 8002, applicationCaseId: 102, mode: "JOB", startedAt: iso(1), endedAt: iso(1), totalScore: 80, avgScore: 78, lastResumedAt: null, createdAt: iso(1) },
  { id: 8001, applicationCaseId: 101, mode: "BASIC", startedAt: iso(3), endedAt: iso(3), totalScore: 74, avgScore: 71, lastResumedAt: iso(0), createdAt: iso(3) },
];
...
export function createSession(req: CreateInterviewSessionRequest): InterviewSession {
  const session: InterviewSession = {
    ...
    startedAt: new Date().toISOString(), endedAt: null, totalScore: null, avgScore: null, lastResumedAt: null, createdAt: new Date().toISOString(),
  };
