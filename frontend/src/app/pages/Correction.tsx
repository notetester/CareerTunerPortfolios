...
import {
  CORRECTION_TABS,
  CORRECTION_MAX_CREDIT_COST,
  CORRECTION_MIN_CREDIT_COST,
...
const correctionMeta: Record<CorrectionTab, {
  ...
  answer: {
    ...
    minCredit: CORRECTION_MIN_CREDIT_COST,
    maxCredit: CORRECTION_MAX_CREDIT_COST,
  },
  cover: {
    title: "자기소개서 첨삭",
              ...
              <CardHeader>
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <Badge className="w-fit bg-amber-100 text-amber-700">
                    ...
                    최소 {active.minCredit} · 최대 {active.maxCredit} 크레딧
                  </Badge>
                </div>
              </CardHeader>
