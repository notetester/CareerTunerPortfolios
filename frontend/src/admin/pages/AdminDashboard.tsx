...
const adminSections = [
  ...
  {
    label: "공고 분석 조회",
    href: "/admin/job-analysis",
    icon: FileText,
    desc: "지원 건별 공고 분석 결과, 요구 역량, 난이도, 생성 시점을 확인합니다.",
    count: "B",
  },
  {
    label: "기업 분석 조회",
    href: "/admin/company-analysis",
    icon: BarChart3,
    desc: "지원 건별 기업 분석 결과, 산업, 이슈, 면접 준비 포인트를 확인합니다.",
    count: "B",
  },
  {
    label: "게시판/신고 관리",
...
const routeLabels: Record<string, string> = {
  ...
  "/admin/job-analysis": "공고 분석 조회",
  "/admin/company-analysis": "기업 분석 조회",
