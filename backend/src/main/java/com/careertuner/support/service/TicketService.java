...
public interface TicketService {
    ...
    /** 사용자가 자신의 문의에 추가 메시지를 남긴다(상태는 재접수로 되돌림). attachmentFileIds 는 선택. */
    TicketThreadResponse addUserMessage(Long ticketId, Long userId, String content, List<Long> attachmentFileIds);
}
