...
public class AdminNotificationFanoutServiceImpl implements AdminNotificationFanoutService {
    ...
    private static final Map<String, List<String>> TYPE_TO_REQUIRED_PERMISSIONS = Map.of(
            "NEW_REPORT", List.of("CONTENT_UPDATE"),
            "NEW_TICKET", List.of("CONTENT_UPDATE"),
            "NEW_JOB_POSTING_REVIEW", List.of("CONTENT_UPDATE"),
            "NEW_COMPANY_APPLICATION", List.of("USER_UPDATE"),
            "NEW_USER", List.of("USER_READ"));
