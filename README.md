...
<p align="center">
  <a href="https://notetester.github.io/CareerTunerPortfolios/"><img src="https://img.shields.io/badge/▶_라이브_데모-GitHub_Pages-2ea44f?logo=github" alt="라이브 데모" /></a>
  <a href="https://notetester.github.io/CareerTunerPortfolios/docs/"><img src="https://img.shields.io/badge/📖_기능_설명서-VitePress-5c73e7?logo=vitepress&logoColor=white" alt="기능 설명서" /></a>
</p>
...
| 무엇 | 링크 |
| --- | --- |
| **라이브 데모** (일반 사용자) | <https://notetester.github.io/CareerTunerPortfolios/login?demo=user> |
| **라이브 데모** (관리자 콘솔) | <https://notetester.github.io/CareerTunerPortfolios/login?demo=admin> |
| **기능 설명서** (아키텍처·도메인별 구현 상세) | <https://notetester.github.io/CareerTunerPortfolios/docs/> |
| **기술 면접 학습 사이트** (A~F 코드 기반) | <https://notetester.github.io/CareerTunerLearning/> |
| **Second Brain 공개 지식 지도** | <https://notetester.github.io/CareerTunerPortfolios/Obsidian/> |
...
기능별 상세 구현·설계 결정은 **[기능 설명서](https://notetester.github.io/CareerTunerPortfolios/docs/)** 에 도메인별로 정리되어 있습니다.

| 도메인 | 핵심 내용 | 설명서 |
| --- | --- | --- |
| **인증·계정·동의** | JWT(access/refresh), 카카오·네이버·구글 OAuth, 이메일 인증, 동의 게이팅, 권한(USER/ADMIN) | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/auth) |
| **프로필·스펙** | 스펙 버저닝, AI 이력서 요약·스킬/키워드 추출·완성도 진단 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/profile) |
| **지원 건·공고 분석** | 공고 이미지/PDF OCR 추출 파이프라인(PaddleOCR/PPStructure), 지원 생애주기 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/application-case) |
| **회사·직무 분석** | 기업 현황·직무 요구사항 구조화 분석, 직무 요약 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/company-job-analysis) |
| **적합도·취업 전략** | 규칙 엔진 점수 + LLM 설명, 근거 게이트로 환각 억제, 자체 파인튜닝 3B 모델 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/fit-analysis) |
| **AI 가상 면접** | 6개 모드, 예상/꼬리 질문, 멀티에이전트 답변 평가, 면접 리포트, RAG(Qdrant), 실시간 음성, 음성/영상 비언어 분석 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/interview) |
| **답변 첨삭** | 자기소개·면접 답변 AI 첨삭 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/correction) |
| **커뮤니티·신고·챗봇** | 게시판, 신고·모더레이션, LangChain4j + Ollama FAQ 챗봇 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/community) |
| **결제·크레딧·요금제** | 사용량 로깅 기반 크레딧 차감, 무료 티어, Toss 결제 흐름 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/billing) |
| **알림** | SSE 인앱 알림, Web Push(VAPID), FCM 폴백 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/notification) |
| **AI 통합·자체 LLM** | 멀티프로바이더 폴백 체인, 자체 파인튜닝 LLM, RAG, 구조화 출력, 사용량 로깅 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/ai-integration) |
| **AI 오케스트레이터** | 동적 계획, 의존 그래프 병렬 실행, SSE 스트리밍, 인테이크 되묻기 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/autoprep) |
| **관리자·운영** | 사용자 기능마다 대응하는 관리자 화면(수십 개), 감사 로그, 슈퍼관리자 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/admin) |
| **데스크탑·모바일** | 반응형 웹 + PWA + Capacitor 8(Android/iOS) + C++17/Qt 6.11/QML 데스크톱 | [문서](https://notetester.github.io/CareerTunerPortfolios/docs/platform) |

## 아키텍처

모노레포로, 백엔드·프런트엔드·데스크탑·ML을 한 저장소에서 관리합니다. 자세한 내용은
[아키텍처 문서](https://notetester.github.io/CareerTunerPortfolios/docs/architecture)를 참고하세요.
...
자세한 내용은 [AI 통합 문서](https://notetester.github.io/CareerTunerPortfolios/docs/ai-integration)에 정리되어 있습니다.
